...
<?php $__env->startSection('page-content'); ?>
    <div style="margin-top: 10px;width: 100%;margin-left: 10px;">
        ...
        <button class="layui-btn layui-btn-normal" onclick="javascrtpt:window.location.href='<?php echo e(url('/admin/cashb/csv')); ?>'">导出提币记录</button>
    </div>
    ...
    <span>{{  d.user_real?d.user_real.name:'-' }}</span>
    </script>
<?php $__env->stopSection(); ?>
        ...
        layui.use(['table','form'], function(){
            ...
            table.render({
                ...
                ,cols: [[ //表头
                    ...
                    ,{field: 'user_real', title: '真实姓名', minWidth:80,templet: '#nametml'}
