    ...
    <script>
        layui.use(['table','form'], function(){
            ...
            table.render({
                elem: '#demo'
                ,toolbar: '#toolbar'
                ,url: "<?php echo e(url('admin/currency_type_list')); ?>" //数据接口
                ,page: true //开启分页
                ,id:'mobileSearch'
                ,cols: [[ //表头
            ...
            table.on('tool(test)', function(obj){
                ...
                if(obj.event === 'del'){
                    layer.confirm('真的删除行么', function(index){
                        $.ajax({
                            url:'<?php echo e(url('admin/currency_type_del')); ?>',
                            type:'post',
                            dataType:'json',
                            data:{id:data.id},
                    ...
                    layer_show('编辑币种类型','<?php echo e(url('admin/currency_type_add')); ?>?id='+data.id);
                }
            });
