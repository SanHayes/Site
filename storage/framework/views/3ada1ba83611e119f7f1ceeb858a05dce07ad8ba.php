...
<?php $__env->startSection('scripts'); ?>
    ...
    <script>
        ...
        layui.use(['table','form'], function(){
            ...
            $('#add_set').click(function(){layer_show('添加', '/admin/micro_seconds_add');});
            ...
            table.render({
                ...
                ,cols: [[ //表头
                    ...
                    ,{field: 'profit_ratio', title: '收益率', minWidth:80, templet:function(obj){
                            return "[ " + obj.profit_ratio + '% - ' + obj.max_ratio + "% ]";
                        }
                    }
                    ,{field: 'money', title: '入场金额', minWidth:80}
            ...
            table.on('tool(test)', function(obj){
                ...
                if(obj.event === 'del'){
                    ...
                    layer_show('编辑','<?php echo e(url('admin/micro_seconds_add')); ?>?id='+data.id);
                }
            });
