            ...
            <div class="layui-tab">
                ...
                <div class="layui-tab-content">
                    ...
                    <div class="layui-tab-item">
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <input type="text" name="web_name" autocomplete="off" class="layui-input"
                                       value="<?php if(isset($setting['web_name'])): ?><?php echo e($setting['web_name'] ?? ''); ?><?php endif; ?>">
                            </div>
                        </div>
                        ...
                        <div class="layui-form-item layui-form-text">
                            ...
                            <div class="layui-input-block">
                                ...
                                <br>
                                <img src="<?php if(!empty($setting['web_logo'])): ?><?php echo e($setting['web_logo']); ?><?php endif; ?>" id="img_thumbnail" class="thumbnail" style="display: <?php if(!empty($setting['web_logo'])): ?><?php echo e("block"); ?><?php else: ?><?php echo e("none"); ?><?php endif; ?>;max-width: 200px;height: auto;margin-top: 5px;">
                                <input type="hidden" name="web_logo" id="thumbnail" value="<?php if(!empty($setting['web_logo'])): ?><?php echo e($setting['web_logo']); ?><?php endif; ?>">
                            </div>
                        </div>
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <div class="layui-input-inline">
                                    <input type="radio" name="online_req" value="1"
                                           title="打开" <?php if(isset($setting['online_req'])): ?> <?php echo e($setting['online_req'] == 1 ? 'checked' : ''); ?> <?php endif; ?> >
                                    <input type="radio" name="online_req" value="0" title="关闭"
                                           <?php if(isset($setting['online_req'])): ?> <?php echo e($setting['online_req'] == 0 ? 'checked' : ''); ?> <?php else: ?> checked <?php endif; ?> >
                                </div>
                                <div class="layui-form-mid layui-word-aux">打开用户将可以使用在线充值功能</div>
                            </div>
                        </div>
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <div class="layui-input-inline">
                                    <input type="radio" name="invitation_code" value="1"
                                           title="必填" <?php if(isset($setting['invitation_code'])): ?> <?php echo e($setting['invitation_code'] == 1 ? 'checked' : ''); ?> <?php endif; ?> >
                                    <input type="radio" name="invitation_code" value="0" title="选填"
                                           <?php if(isset($setting['invitation_code'])): ?> <?php echo e($setting['invitation_code'] == 0 ? 'checked' : ''); ?> <?php else: ?> checked <?php endif; ?> >
                                </div>
                                <div class="layui-form-mid layui-word-aux">打开用户将可以使用在线充值功能</div>
                            </div>
                        </div>
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <div class="layui-input-inline">
                                    <input type="text" name="api_url" autocomplete="off" class="layui-input"
                                       value="<?php if(isset($setting['api_url'])): ?><?php echo e($setting['api_url'] ?? ''); ?><?php endif; ?>">
                                </div>
                                <div class="layui-form-mid layui-word-aux">请勿私自修改</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <!-- <div class="layui-form-item">
                        ...
                        <div class="layui-form-item">
                            <label class="layui-form-label">APP下载链接</label>
                            <div class="layui-input-block">
                                <input type="text" name="app_direct" autocomplete="off" class="layui-input"
                                       value="<?php if(isset($setting['app_direct'])): ?><?php echo e($setting['app_direct'] ?? ''); ?><?php endif; ?>">
                            </div>
                        </div>
                    ...
                    <div class="layui-tab-item">
                        ...
                        <div class="layui-form-item">
                            <label class="layui-form-label">选择安卓文件</label>
                            <div class="layui-input-block">
                        ...
                        <div class="layui-form-item">
                            <label class="layui-form-label">选择苹果文件</label>
                            <div class="layui-input-block">
