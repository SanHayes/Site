                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-inline">
                            <div class="layui-input-inline" style="width: 120px;">
                                <input type="text" class="layui-input" name="fluctuate_min" placeholder="最小值" value="<?php echo e($currency_match->fluctuate_min ?? 0.0001); ?>" >
                            </div>
                            <div class="layui-form-mid">-</div>
                            <div class="layui-input-inline" style="width: 120px;">
                                <input type="text" class="layui-input" name="fluctuate_max" placeholder="最大值" value="<?php echo e($currency_match->fluctuate_max ?? 0.0005); ?>" >
                            </div>
                        </div>
                    </div>
                    <div class="layui-form-item">
