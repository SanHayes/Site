    ...
    $('.background-upload').on('click', function () {
        ...
        input.on('change', function () {
            ...
            if (src) {
                ...
                //改变预览背景
                $('.background-preview').css('background-image', 'url(images/xp.jpg)');
                //改变父页面背景
                winui.resetBg('images/xp.jpg');
    ...
    $('.lockscreen-upload').on('click', function () {
        ...
        input.on('change', function () {
            ...
            if (src) {
                layer.msg('选择了路径【' + src + '】下的图片，返回一张性感的Girl给你')
                //改变锁屏预览
                $('.lockscreen-preview').css('background-image', 'url(images/xp.jpg');
                //设置锁屏背景
                winui.resetLockBg('images/xp.jpg');
                $(this).val('').off('change');
            }
        })
    });
