                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <select name="currency_type" lay-verify="required">
                                @foreach ($currency_from_names as $key => $currency_from_name)
                                    <option value="{{ $key }}" @if ((isset($currency_match) && $currency_match->currency_type == $key)) selected @endif>{{ $currency_from_name }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <div class="layui-input-inline" style="width: 100%;">
                                <input type="text" class="layui-input" name="currency_code" placeholder="除加密货币之外，需要填写币种编码" value="{{ $currency_match->currency_code ?? '' }}" >
                            </div>
                        </div>
                    </div>
                    <div class="layui-form-item">
                        ...
                        <div class="layui-inline">
                            <div class="layui-input-inline" style="width: 120px;">
                                <input type="text" class="layui-input" name="fluctuate_min" placeholder="最小值" value="{{ $currency_match->fluctuate_min ?? 0.0001 }}" >
                            </div>
                            <div class="layui-form-mid">-</div>
                            <div class="layui-input-inline" style="width: 120px;">
                                <input type="text" class="layui-input" name="fluctuate_max" placeholder="最大值" value="{{ $currency_match->fluctuate_max ?? 0.0005 }}" >
                            </div>
                        </div>
                    </div>
                    <div class="layui-form-item">
