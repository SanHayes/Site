            ...
            <div class="layui-tab-content">
                ...
                <div class="layui-tab-item">
                    <div id="micro_trade_fee" class="layui-form-item {{$result->is_micro == 1 ? '' : 'hide'}}">
                        ...
                        <div class="layui-input-inline">
                            <input type="number" class="layui-input" id="" name="micro_trade_fee" value="{{$result->micro_trade_fee ?? 0}}" placeholder="百分比">
                        </div>
                        <div class="layui-form-mid layui-word-aux">%</div>
                    </div>
                    <div class="layui-form-item">
                        <label class="layui-form-label">下单数量范围</label>
                            <div class="layui-input-inline">
                                <input type="number" class="layui-input" name="micro_min" value="{{$result->micro_min ?? 10}}" placeholder="最小数量">
                            </div>
                            <div class="layui-form-mid">-</div>
                            <div class="layui-input-inline">
                                <input type="number" class="layui-input" name="micro_max" value="{{$result->micro_max ?? 1000000}}" placeholder="最大数量">
                            </div>
                        </div>
                        <div class="layui-form-item">
                            <label class="layui-form-label">最大持仓笔数</label>
                            <div class="layui-input-inline">
                                <input type="number" class="layui-input" name="micro_holdtrade_max" value="{{$result->micro_holdtrade_max ?? 0}}" placeholder="最大持仓笔数">
                            </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="number" class="layui-input" id="end_time" name="min_number" value="{{$result->min_number ?? 10}}" placeholder="最小数量">
                        </div>
                        <div class="layui-form-mid">-</div>
                        <div class="layui-input-inline">
                            <input type="number" class="layui-input" id="end_time" name="max_number" value="{{$result->max_number ?? 10000000}}" placeholder="最大数量">
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <label class="layui-form-label">提币费率</label>
                        <div class="layui-input-inline">
                            <input type="number" class="layui-input" id="end_time" name="rate" value="{{$result->rate ?? 10}}" placeholder="百分比">
                        </div>
                        <div class="layui-form-mid"></div>
                    </div>
                </div>
                ...
                <div class="layui-tab-item">
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" id="type" name="type" class="layui-input" value="{{$result->type ?? 'usdt'}}">
                        </div>
