                    ...
                    <div class="layui-tab-item">
                        ...
                        <div class="layui-form-item layui-form-text">
                            ...
                            <div class="layui-input-block">
                                ...
                                <br>
                                <img src="@if(!empty($setting['web_logo'])){{$setting['web_logo']}}@endif" id="img_thumbnail" class="thumbnail" style="display: @if(!empty($setting['web_logo'])){{"block"}}@else{{"none"}}@endif;max-width: 200px;height: auto;margin-top: 5px;">
                                <input type="hidden" name="web_logo" id="thumbnail" value="@if(!empty($setting['web_logo'])){{$setting['web_logo']}}@endif">
                            </div>
                        </div>
                            ...
                            <div class="layui-input-block">
                                <div class="layui-input-inline">
                                    <input type="radio" name="online_req" value="1"
                                           title="打开" @if (isset($setting['online_req'])) {{$setting['online_req'] == 1 ? 'checked' : ''}} @endif >
                                    <input type="radio" name="online_req" value="0" title="关闭"
                                           @if (isset($setting['online_req'])) {{$setting['online_req'] == 0 ? 'checked' : ''}} @else checked @endif >
                                </div>
                            ...
                            <div class="layui-input-block">
                                <div class="layui-input-inline">
                                    <input type="radio" name="invitation_code" value="1"
                                           title="必填" @if (isset($setting['invitation_code'])) {{$setting['invitation_code'] == 1 ? 'checked' : ''}} @endif >
                                    <input type="radio" name="invitation_code" value="0" title="选填"
                                           @if (isset($setting['invitation_code'])) {{$setting['invitation_code'] == 0 ? 'checked' : ''}} @else checked @endif >
                                </div>
                                <div class="layui-form-mid layui-word-aux">打开用户将可以使用在线充值功能</div>
                            </div>
                        </div>
                            ...
                            <div class="layui-input-block">
                                <div class="layui-input-inline">
                                    <input type="text" name="api_url" autocomplete="off" class="layui-input"
                                       value="@if(isset($setting['api_url'])){{$setting['api_url'] ?? ''}}@endif">
                                </div>
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <input type="text" name="app_direct" autocomplete="off" class="layui-input"
                                       value="@if(isset($setting['app_direct'])){{$setting['app_direct'] ?? ''}}@endif">
                            </div>
                        </div>
