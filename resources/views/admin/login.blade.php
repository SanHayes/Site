...
<div style="width: 400px;height: 250px;margin: auto auto;background: #ffffff;text-align: center;margin-top: -100px;border: 1px solid #e7e7e7">
	...
	<p style="padding: 10px 0px 10px 0px;position: relative;">
    	...
    	<img src="images/google.png" width="16px" height="16px" style="display: inline-block;position: absolute;left: 40px;top: 20px;" />
    	<input class="ipt" type="text" id="google_code" name="google_code" placeholder="请输入验证码">
	</p>
