...
class UsersWalletOut extends Model
{
    ...
    protected $appends = ['currency_name', 'account_number', 'currency_type','user_info','user_real'];
    //节点等级
    ...
    public function getUserRealAttribute()
    {
        return $this->hasOne('App\UserReal','user_id','user_id')->first();
    }
