...
//    const WALLET_LEVEL_CNANGE_IN = 209;//杠杆转入闪兑
    ...
    public static function insertLog($data = array(), $data2 = array())
    {
        ...
        $data_wallet['memo_en'] = $log->info_en;
        $data_wallet['memo_kr'] = $log->info_kr;
        $data_wallet['memo_hk'] = $log->info_hk;
        $data_wallet['memo_jp'] = $log->info_jp;
        $data_wallet['memo_spa'] = $log->info_spa;
