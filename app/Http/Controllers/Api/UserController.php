...
//        $legal_wallet['CNY'] = '';
    ...
    public function realName()
    {
        ...
        $user_id = Users::getUserId();
        $name = htmlspecialchars(Input::get("name", ""));//真实姓名
        $card_id = htmlspecialchars(Input::get("card_id", ""));//身份证号
        $front_pic = htmlspecialchars(Input::get("front_pic", ""));//正面照片
        $reverse_pic = htmlspecialchars(Input::get("reverse_pic", ""));//反面照片
