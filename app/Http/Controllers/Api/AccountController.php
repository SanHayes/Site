...
class AccountController extends Controller
{
    ...
    public function list()
    {
        ...
        $data = AccountLog::where("user_id", $user->id)->orderBy('id', 'DESC')->paginate($limit, ['*'], 'page', $page);
...
//           sleep(1);
    ...
    public function show_profits(Request $request)
    {
        ...
        })->where("type", AccountLog::PROFIT_LOSS_RELEASE)->where("user_id", "=", $user_id)->orderBy('id', 'desc')->paginate($limit, ['*'], 'page', $page);
